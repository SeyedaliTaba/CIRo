...
type BSConfig struct {
	...
	// CarbonForecastInterval is interval between carbon intensity forecasting computations
	CarbonForecastInterval util.DurWrap `toml:"carbon_forecast_interval,omitempty"`
