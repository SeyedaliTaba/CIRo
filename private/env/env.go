...
const (
	...
	GeolocationFile = "geolocation.json"

	ElectricityMapsAPIKeyFile = "electricityMapsAPIKeyFile.json"
...
func (cfg *General) Geolocation() string {
	return filepath.Join(cfg.ConfigDir, GeolocationFile)
}

func (cfg *General) ElectricityMapsAPIKeyConfig() string {
	return filepath.Join(cfg.ConfigDir, ElectricityMapsAPIKeyFile)
}
